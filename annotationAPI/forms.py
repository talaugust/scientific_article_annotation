    ...
    class Meta:
        ...
        labels = {
            'is_lead': 'Is there a lead? If so, please highlight the sentences that make up the lead and label the highlight \'LEAD\'.',
         	'lead_interest':'Please highlight the lead and rate, on a scale from 1-5, 1 being not at all and 5 being extremely, how excited the lead made you about the rest of the article.',
